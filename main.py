...
DF_PATH = os.path.join(BASE_DIR, "dt.pkl")
...
# Represents a compact movie card containing basic TMDB movie information
# such as title, poster, release date, and user rating.
...
# Represents detailed information about a movie fetched from TMDB,
# including its description, images, release date, and genres.
...
# Represents a movie recommendation generated by the TF-IDF model,
# including its similarity score and optional TMDB movie details.
...
# Represents the complete API response containing the searched movie's
# details along with TF-IDF-based and genre-based recommendations.
